    ...
    %{
      ...
      files: %{
        ...
        excluded: [
          ...
          ~r"/deps/",
          ~r"/node_modules/",
          "test/integration/support/event_helpers.ex",
          # TODO: Remove when credo fixes the apply/2, apply/3 bug
          "lib/subscription_service_web/live/subscription/components/events.ex",
          "lib/subscription_service_api/orchestrator.ex"
        ]
      },
      #
